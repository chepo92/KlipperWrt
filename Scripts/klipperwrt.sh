...
echo " "
echo "This script will format your storage media and create a BTRFS filesystem"
echo " "
echo "   ##########################################################"
echo "   ## Make sure you've got some storage media plugged in!  ##"
echo "   ##########################################################"
echo " "
...
format(){
	while true; do
	    read -p "This script will format your storage media. THIS WILL DELETE ALL THE DATA ON YOUR STORAGE MEDIA! [y/n]: " yn
	    case $yn in
		[Yy]* ) break;;
		[Nn]* ) exit;;
